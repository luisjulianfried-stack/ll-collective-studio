...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'LL Collective Studio — Built to be remembered.', description: 'Strategie, Design und Content für Marken, die im Gedächtnis bleiben.', type: 'website', locale: 'de_DE', images: ['/social.svg'] },
