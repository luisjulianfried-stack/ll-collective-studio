...
export const ARCHITECTURE_DEMO_URL = '/showcase/architektur/index.html';
...
export function ArchitectureShowcase({ number }: { number: string }) {
  ...
  return <div className="possibility-canvas possibility-web possibility-web-demo">
    ...
    <div className="study-web study-web-demo">
      ...
      >
        <Image src="/showcase/architektur-preview.webp" alt="Startseite der Architektur-Website: Villa am Abend mit der Headline „Räume für ein Leben mit Anspruch.“" fill unoptimized sizes="(max-width: 700px) 88vw, 820px" className="web-demo-image"/>
      ...
      <div className="web-flow web-demo-flow"><span>INTERAKTIV</span><strong>3D-Hausführung</strong><i>·</i><strong>Grundriss</strong><i>·</i><strong>Materialien</strong></div>
    </div>
